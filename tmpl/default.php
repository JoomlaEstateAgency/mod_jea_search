...
JHtml::stylesheet('mod_jea_search/mod_jea_search.css', array('relative' => true));

if (!JFile::exists(JPATH_SITE . '/media/com_jea/js/jquery-search.js'))
{
...
<?php endif ?>
	...
	<p>
		<strong><?php echo JText::_('COM_JEA_LOCALIZATION') ?> :</strong>
	</p>
	...
	<p>
		<strong><?php echo JText::_('COM_JEA_BUDGET') ?> :</strong>
	</p>

	<dl class="col-left">
		<dt>
			<label for="jea-search-budget-min<?php echo $uid ?>"><?php echo JText::_('COM_JEA_MIN') ?> : </label>
		</dt>
		<dd>
	...
	<dl class="col-right">
		<dt>
			<label for="jea-search-budget-max<?php echo $uid ?>"><?php echo JText::_('COM_JEA_MAX') ?> : </label>
		</dt>
		<dd>
	...
	<p>
		<strong><?php echo JText::_('COM_JEA_FIELD_LIVING_SPACE_LABEL') ?> :</strong>
	</p>

	<dl class="col-left">
		<dt>
			<label for="jea-search-living-space-min<?php echo $uid ?>"><?php echo JText::_('COM_JEA_MIN') ?> : </label>
		</dt>
		<dd>
	...
	<dl class="col-right">
		<dt>
			<label for="jea-search-living-space-max<?php echo $uid ?>"><?php echo JText::_('COM_JEA_MAX') ?> : </label>
		</dt>
		<dd>
	...
	<p>
		<strong><?php echo JText::_('COM_JEA_FIELD_LAND_SPACE_LABEL') ?> :</strong>
	</p>

	<dl class="col-left">
		<dt>
			<label for="jea-search-land-space-min<?php echo $uid ?>"><?php echo JText::_('COM_JEA_MIN') ?> : </label>
		</dt>
	...
	<dl class="col-right">
		<dt>
			<label for="jea-search-land-space-max<?php echo $uid ?>"><?php echo JText::_('COM_JEA_MAX') ?> : </label>
		</dt>
		<dd>
	...
	<p>
		<strong><?php echo JText::_('COM_JEA_SEARCH_OTHER') ?> :</strong>
	</p>
	...
	<ul class="jea-search-other">
		...
		<li>
			...
			<input id="jea-search-floor<?php echo $uid ?>" type="text" name="filter_floor" size="2"
				value="<?php echo $states['filter_floor'] ?>" /> <em><?php echo JText::_('COM_JEA_SEARCH_FLOOR_DESC') ?></em>
		</li>
		<?php endif?>

		<?php if ($params->get('show_hotwatertypes', 0)): ?>
		<li>
			<?php echo JHtml::_('features.hotwatertypes', $states['filter_hotwatertype'], 'filter_hotwatertype', array('id' => 'hotwatertype'.$uid ) ) ?>
		</li>
		<?php endif?>

		<?php if ($params->get('show_heatingtypes', 0)): ?>
		<li>
			<?php echo JHtml::_('features.heatingtypes', $states['filter_heatingtype'], 'filter_heatingtype', array('id' => 'heatingtype'.$uid ) ) ?>
		</li>
		<?php endif?>

		<?php if ($params->get('show_conditions', 0)): ?>
		<li>
			<?php echo JHtml::_('features.conditions', $states['filter_condition'], 'filter_condition', array('id' => 'condition'.$uid ) ) ?>
		</li>
		<?php endif?>
	...
	<p>
		...
		<input type="submit" class="button"
			value="<?php echo $useAjax ? JText::_('COM_JEA_LIST_PROPERTIES') : JText::_('JSEARCH_FILTER_SUBMIT')?>" />
	</p>
